...
write("<nobr><font style=\"font-weight:normal;\">Набор батарей<br>База</font></nobr>");
write("</p>");
...
write("<nobr><font style=\"font-weight:normal;\">Передний бампер<br>балка</font></nobr>");
write("</p>");
...
write("<nobr><font style=\"font-weight:normal;\"Правая сторона Усиление амортизатора");
write("</p>");
...
write("<nobr><font style=\"font-weight:normal;\">Левая сторона<br>Усиление амортизатора</font></nobr>");
write("</p>");
...
write("<nobr><font style=\"font-weight:normal;\">Автомобили с электрическими раздвижными дверями</font></nobr>");
write("</p>");
